...
namespace CSAS.Services
{
    public class OutlookService
    {
        ...
        public bool SendEmail(MailAddress sender, string subject, MailAddressCollection to, MailAddressCollection cc, string body, IList<string> attachments, bool modal)
        {
            ...
            //foreach (O.Account a in app.Session.Accounts)
            //{
            //	//var x = a.CurrentUser.AddressEntry.Address;
            //	//var y = a.SmtpAddress;
            //	//var z = a.CurrentUser.AddressEntry.GetExchangeUser()?.PrimarySmtpAddress;
            //	//if (x.Equals(sender, StringComparison.InvariantCultureIgnoreCase)
            //	//	|| y.Equals(sender, StringComparison.InvariantCultureIgnoreCase)
            //	//	|| z.Equals(sender, StringComparison.InvariantCultureIgnoreCase))
            //	//{
            //	//	account = a;
            //	//	break;
            //	//}
            //	if (a.SmtpAddress.Equals(sender.Address, StringComparison.InvariantCultureIgnoreCase))
            //	{
            //		account = a;
            //	}
            //}
