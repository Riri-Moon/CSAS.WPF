...
namespace CSAS.Services
{
    public class ExcelService : IExcelService
    {
        ...
        {
            _excelFile = SpreadsheetDocument.Create(filePath, SpreadsheetDocumentType.Workbook);
        ...
        public void WriteRow(string sheetName, int rowIndex, bool overwriteStyle, params string[] values)
        {
            ...
            {
                var cell = InsertCellInWorksheet(GetExcelColumnName(columnIndex), (uint)rowIndex, columnIndex, worksheetPart, overwriteStyle);
        ...
        private static Cell InsertCellInWorksheet(string columnName, uint rowIndex, int columnIndex, WorksheetPart worksheetPart, bool overwrite)
        {
            ...
            {
                return row.Descendants<Cell>().ElementAt(columnIndex - 1);
            }
        }
